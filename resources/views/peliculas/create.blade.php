    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('peliculas.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <textarea type="text" class="form-control" name="sinopsis" rows="2" autofocus required placeholder="Detalle de la pelicula"></textarea>
                                    <br>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" class="form-control" name="precio_unitario" placeholder="Precio" autofocus required>
                                </div>
                            </div>
                            <div class="row">
                                <label for="genero" class="col-sm-2 col-form-label">Genero</label>
                                <div class="col-sm-7">
                                    <!-- <input type="number" class="form-control" name="precio" placeholder="Precio" autofocus required> -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="date" class="form-control" name="fecha_estreno" placeholder="Precio" autofocus required>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <label for="lanzamiento" class="col-sm-2 col-form-label">Lanzaminetos</label>
                                <div class="col-sm-7">
