...
['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('VIDEOCLUB - LOG-IN')])

@section('content')
<div class="container" style="height: auto;">
    <div class="row align-items-center">
        <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
            <h3>{{ __('Iniciar Sesion para hacer su reserva') }}
            </h3>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                            <div class="input-group">
                                ...
                                <!--el value nos sirve por si no ingresa el correctamente los datos-->
